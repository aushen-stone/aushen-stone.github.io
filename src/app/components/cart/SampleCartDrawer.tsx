          ...
          >
            <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-200 flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs uppercase tracking-[0.14em] sm:tracking-[0.18em] text-gray-500">Sample Cart</p>
            ...
            <div className="px-4 sm:px-6 py-4 sm:py-5 border-t border-gray-200 space-y-3">
              <button
                type="button"
              ...
              <Link
                href="/cart"
                onClick={closeDrawer}
                className="block w-full bg-[#1a1c18] text-[#F8F5F1] py-3 text-center text-[11px] sm:text-xs uppercase tracking-[0.14em] sm:tracking-[0.18em] hover:bg-[#3B4034] transition-colors"
              >
                View Cart
              </Link>
            </div>
