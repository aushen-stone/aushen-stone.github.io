  ...
  return (
    <main className="min-h-screen bg-[#F8F5F1] text-[#1a1c18] selection:bg-[#1a1c18] selection:text-white">
      ...
      <section className="page-padding-x py-12 sm:py-16 md:py-20">
        <div className="mx-auto grid max-w-[1400px] gap-10 lg:grid-cols-[18rem_minmax(0,1fr)] lg:gap-16">
          <aside className="lg:sticky lg:top-[calc(var(--content-sticky-top)+1.5rem)]">
            <div
              id="terms-index"
