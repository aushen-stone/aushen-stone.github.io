...
function EditorialHero() {
  return (
    <section className="relative min-h-screen bg-[#F8F5F1] pt-32 pb-20 px-6 md:px-12 flex flex-col md:flex-row items-center overflow-hidden">
      ...
      <div className="w-full md:w-1/2 relative z-10 flex flex-col justify-center h-full md:pr-12">
         ...
         >
           ...
           <h1 className="font-serif text-6xl md:text-8xl text-[#1a1c18] leading-[0.95] mb-8">
             The Stone <br/>
         ...
         <motion.div
           ...
           className="mt-12 flex items-center gap-4 text-[#1a1c18]/40"
         >
      ...
      <div className="w-full md:w-1/2 h-[50vh] md:h-[80vh] relative mt-12 md:mt-0">
         <motion.div
...
function Manifesto() {
  ...
  return (
    <section className="bg-[#2C3025] text-[#F0F2E4] py-32 md:py-48 px-6 md:px-12 relative overflow-hidden">
       {/* 背景纹理 */}
...
function TimelineSection() {
  ...
  return (
    <section className="bg-[#E8E6E1] py-32 px-6 md:px-12 relative">
          ...
          <div className="flex flex-col gap-32">
             {items.map((item, i) => (
               <motion.div
                 ...
                 className={`flex flex-col md:flex-row items-center gap-12 md:gap-24 ${item.align === 'right' ? 'md:flex-row-reverse' : ''}`}
               >
                  {/* Image Side */}
                  ...
                  <div className="w-full md:w-1/2 text-center md:text-left">
                     ...
                     <h3 className="font-serif text-4xl md:text-5xl text-[#1a1c18] mb-6">{item.title}</h3>
